        ...
        <div className="contact-hero-overlay">
          ...
          >
            ...
            <p className="contact-hero-description">
              Have questions or want to make a booking? Reach out to us and we
            ...
            >
              ...
              <div className="additional-info">
                ...
                <ul>
                  ...
                  <li>
                    <FaCheckCircle className="info-icon" />
                    Explore modern amenities that make life easier and more
                    enjoyable
                  </li>
                  <li>
                    <FaCheckCircle className="info-icon" />
                    Discover what makes Avaition Heights Apartments the talk of
                    the neighborhood
                  </li>
                  <li>
                    <FaCheckCircle className="info-icon" />
                    Visit today — your dream apartment might be waiting right
                    here
                  </li>
                </ul>
              </div>
